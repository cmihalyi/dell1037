JPE.declare('SpringConstraintParticle', {
		 ...
		 */
		constructor: function(p1, p2, p, rectHeight, rectScale, scaleToLength, bottomConnector) {
			
			
			this.p1 = p1;
			this.p2 = p2;
//			console.log("scp - bottomConnector - " + bottomConnector);
			...
			this.parent = p;
			JPE.SpringConstraintParticle.superclass.prototype.constructor.call(this, 0, 0, 0, 0, 0, false, 1, 0.3, 0, bottomConnector);
