JPE.declare('SpringConstraint', {
		 ...
		 */
		constructor: function(p1, p2, stiffness, collidable, rectHeight, rectScale, scaleToLength, bottomConnector){
		...
		setCollidable: function(b, rectHeight, rectScale, scaleToLength) {
			...
			if (this._collidable) {
				...
				this.scp = new JPE.SpringConstraintParticle(this.p1, this.p2, this, rectHeight, rectScale, scaleToLength, this.bottomConnector);
				if(this.inited){
					this.scp.initSelf();
				}
			}
