JPE.declare('RectangleParticle',  {
		 ...
		 * </p>
		 */
		constructor: function(x, y, width, height, rotation, fixed, mass, elasticity, friction, bottomConnector, connector) {
			...
			JPE.RectangleParticle.superclass.prototype.constructor.call(this, x, y, fixed, mass, elasticity, friction, bottomConnector, connector);
		},
		 ...
		 */	
		getExtents: function () {
			// console.log("get Extents: " + this._extents[0] + ", " + this._extents[1]);
