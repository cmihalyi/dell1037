(function (window) {
	...
	function Tutorial1Tablet(main) {
//		console.log('constructing Tutorial1Tablet');
		this.root = null;
		this.top = null;
		this.body = null;

		this.BASE_NAME = 'tutorial1-tablet-page';
	...
	Tutorial1Tablet.prototype = new Page();

	Tutorial1Tablet.prototype.parent = Page.prototype;

	Tutorial1Tablet.prototype.create = function() {
	...
	Tutorial1Tablet.prototype.activate = function(content) {
	...
	Tutorial1Tablet.prototype.distributeContent = function(content) {
		var instance = this;
	...
	Tutorial1Tablet.prototype.attach = function() {
		this.root.appendTo('#main-wrapper-content-body');
	};

	Tutorial1Tablet.prototype.detach = function() {
		this.root.detach();
	};

	window.Tutorial1Tablet = Tutorial1Tablet;
