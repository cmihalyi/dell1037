(function (window) {
	...
	function Tutorial4(main) {
//		console.log('constructing Tutorial4');
		this.root = null;
		this.top = null;
		this.body = null;

		this.BASE_NAME = 'tutorial4-page';
	...
	Tutorial4.prototype = new Page();

	Tutorial4.prototype.parent = Page.prototype;

	Tutorial4.prototype.create = function() {
	...
	Tutorial4.prototype.activate = function(content) {
	...
	Tutorial4.prototype.distributeContent = function(content) {
		var instance = this;
	...
	Tutorial4.prototype.attach = function() {
		this.root.appendTo('#main-wrapper-content-body');
	};

	Tutorial4.prototype.detach = function() {
		this.root.detach();
	};

	window.Tutorial4 = Tutorial4;
